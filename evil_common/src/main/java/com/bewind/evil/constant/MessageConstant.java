package com.bewind.evil.constant;
/**
 * 消息常量
 */
public interface MessageConstant {
    static final String DELETE_MALFUNCTION_FAIL = "删除维修项失败";
    static final String DELETE_MALFUNCTION_SUCCESS = "删除维修项成功";
    static final String ADD_MALFUNCTION_SUCCESS = "新增维修项成功";
    static final String ADD_MALFUNCTION_FAIL = "新增维修项失败";
    static final String EDIT_MALFUNCTION_FAIL = "编辑维修项失败";
    static final String EDIT_MALFUNCTION_SUCCESS = "编辑维修项成功";
    static final String QUERY_MALFUNCTION_SUCCESS = "查询维修项成功";
    static final String QUERY_MALFUNCTION_FAIL = "查询维修项失败";
    ...
    static final String EDIT_PERMISSION_FAIL = "编辑权限数据失败";
    static final String EDIT_PERMISSION_SUCCESS = "编辑权限数据成功";
