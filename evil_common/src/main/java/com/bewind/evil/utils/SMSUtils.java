...
//	private static final String SIGN_NAEM = "gang";// 短信的签名
...
//	private static final String SECRET_KEY="dIVZnHGdUTYbqOKMlxZ7R7jXVcnPoz"; //你的AccessKey Secret
	...
	public static final String VALIDATE_CODE = "SMS_198677609";//发送短信验证码
	public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
	private static final String SIGN_NAEM = "小子";// 短信的签名
	private static final String PARAMETER_NAME="code";
	private static final String ACCESS_KEY="LTAI4GAVyQzbXGiHKFMZgs1j"; //你的AccessKey ID
	private static final String SECRET_KEY="jzwb2SQsAJCrCMmmlMlSCeNSVXICLp"; //你的AccessKey Secret

	public static void main(String[] args) throws ClientException {
//		SMSUtils.sendShortMessage(VALIDATE_CODE,"13652431027","666666");
		SMSUtils.sendShortMessage(VALIDATE_CODE,"18269571005","666666");
	}
